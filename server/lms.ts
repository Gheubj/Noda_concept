...
Во вкладке **«Данные»** можно загрузить свой CSV и указать **целевую колонку**. Если таблиц в проекте нет, подставляется **Iris.csv** — выбери его в **«Обучение»**. Несколько строк для проверки — в **«Входы»** или вручную в блоке предсказания.`
      },
