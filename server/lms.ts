...
Ты в **цифровом Архиве Noda** — не как зритель, а как **стажер-детектив данных**. Я веду без лозунгов: коротко, по фактам, с вопросом «какая цепочка наблюдений за этим стоит?».
...
Инструменты стажера — **блоки**: логику собирают цепочкой, без кода с нуля.`
      },
      {
        ...
        caption: "Палитра блоков Noda: события, данные, обучение, предсказание и вывод."
      },
      {
        id: "q08_blocks_text",
        type: "text",
...
Минимальная цепочка для нашего дела: **Старт → датасет Iris → обучить модель → предсказать → уверенность/класс → показать результат**.`
      },
      {
        id: "q08_blocks_check",
        type: "checkpoint",
