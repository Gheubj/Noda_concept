...
Ты — стажер Академии Noda. Первый день должен был быть вводным, но Архив уже вызывает тебя на срочное дело.

Твой ментор — **Нодус**, хранитель историй и детектив данных. Он умеет видеть связи между фактами, но без модели Архив не справится достаточно быстро.`
      },
      {
        id: "q00_hero",
        type: "media",
        ...
        caption: "Экстренный вызов: в цифровом Архиве Noda открыт протокол стажера."
      },
      {
        id: "q00_problem",
        type: "text",
        body: `## Экстренный вызов Нодуса — 7 минут

В архивной оранжерее исчезли подписи у редких ирисов. Одновременно в симуляции распространяется вымышленная **Серебряная пыльца**.

По легенде Архива, остановить ее может пигмент только одного вида ирисов. Но вручную проверять сотни растений слишком долго.

**Задача стажера:** понять основы ИИ и собрать модель, которая определит вид ириса по измерениям.`
      },
      {
        id: "q00_hypothesis",
        type: "checkpoint",
...

      {
        ...
        type: "text",
        body: `## Сцена 1. ИИ уже рядом — 12 минут

Нодус начинает брифинг: прежде чем спасать оранжерею, стажер должен понять, где ИИ уже работает вокруг нас.

ИИ — это не магия. Это программы, которые учатся на примерах, ищут закономерности и делают предсказания.`
      },
      {
        id: "q01_ai_examples",
        type: "text",
...
Если ИИ может узнать лицо, голос и вкус зрителя, значит он может помочь узнать и вид ириса.`
...

      {
        id: "q02_what_is_ai",
        type: "text",
        body: `## Сцена 2. Что такое ИИ на самом деле — 12 минут
...
Сегодня важнее понять цикл: **данные → обучение → проверка → предсказание**.`
...

      {
        id: "q03_data_title",
        type: "text",
        body: `## Сцена 3. Данные — еда для ИИ — 12 минут
...
Если подписи повреждены, модель получает плохие уроки. Поэтому качество разметки — часть расследования.`
...

      {
        ...
        type: "text",
        textScale: "lg",
        body: `## Сцена 4. Досье Iris — 15 минут
...
Один вид содержит нужный пигмент против Серебряной пыльцы. Но подписи у части цветов исчезли. Остались только измерения.`
      },
      {
        ...
        caption: "Досье Iris: три класса, измерения и поврежденные подписи."
      },
      {
        id: "q04_table",
        type: "text",
...
- задача = классификация.`
...

      {
        ...
        type: "text",
        body: `## Сцена 5. Как модель учится — 12 минут
...
Если показать модели тест заранее, она может просто запомнить ответы.`
...

      {
        ...
        type: "text",
        body: `## Сцена 6. Метрики: можно ли доверять модели — 10 минут
...
Loss должен уменьшаться. Accuracy на тестовой выборке важнее красивой уверенности в одном ответе.`
...

      {
        id: "q07_fit_title",
        type: "text",
        body: `## Сцена 7. Ловушки обучения — 8 минут
...
- train высокий, test низкий → переобучение.`
...

      {
        id: "q08_noda_title",
        type: "text",
        body: `## Сцена 8. Noda: набор инструментов стажера — 7 минут
...
- **Показать результат / журнал** — выводит ответ пользователю.`
...

      {
        ...
        type: "text",
        textScale: "lg",
        body: `## Сцена 9. Финальная практика: спасти оранжерею — 20 минут
...
Нужно собрать мини-разработку на Iris и проверить, сможет ли модель восстановить подписи цветов.`
      },
      {
        ...
        caption: "Аварийная лаборатория Noda: данные, модель и предсказание."
      },
      {
        id: "q09_studio",
        type: "studio",
...

      {
        id: "q10_final_title",
        type: "text",
        body: `## Сцена 10. Дело закрыто — 4 минуты
...
В следующем расследовании модель будет учиться распознавать объекты не по таблицам, а по картинкам.`
  ...
  await prisma.lessonTemplate.upsert({
    ...
    create: {
      ...
      description: "90-минутное детективное дело: основы ИИ, Iris dataset и первая модель в Noda.",
      moduleKey: "module_a",
      sortOrder: 0,
      starterPayload: EMPTY_SNAPSHOT,
      ...
      studentSummary: "90-минутный детективный квест: Нодус вводит стажера в основы ИИ, а затем ученик собирает модель для дела Ирисового шифра."
    },
    update: {
      title: "Дело Ирисового шифра",
      description: "90-минутное детективное дело: основы ИИ, Iris dataset и первая модель в Noda.",
