...
/** Панель «сцены»: статус сценария; в мини-студии — инструкция, цели и персонаж. */
        ...
        <Card size="small" title="Сцена" className="studio-stage-card">
          <div className="studio-stage-panel__mini-layout">
            <div className="studio-stage-panel__mini-figure-wrap">
              <img className="studio-stage-panel__mini-figure" src="/nodly-coach.svg" alt="" width={96} height={96} />
            </div>
            <div className="studio-stage-panel__mini-copy">
              {instructionMarkdown.trim() ? (
                ...
                <Text type="secondary">Следуй шагам в Blockly ниже.</Text>
              )}
              {goals.length > 0 ? (
